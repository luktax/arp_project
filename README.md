...
HOW TO RUN
In the main folder /arp_project is present a a file named "run.sh", it is a simple script, which compile all the file using the CMakeFile.txt file and then start the program.
To execute:
./run.sh
